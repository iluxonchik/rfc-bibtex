...
class Parser(object):
    ...
    def build_parser(self):
            ...
            parser = argparse.ArgumentParser(description='Generate Bibtex entries for RFCs and Internet-Drafts. Titles are output to preserve the original capitalization.')
